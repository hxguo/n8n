...
export class InsightsService {
	constructor(
		...
		private readonly insightsBufferService: InsightsCollectionService,
	) {
		this.insightsBufferService.startFlushingTimer();
		this.insightsCompactionService.startCompactionTimer();
	}

	@OnShutdown()
	async shutdown() {
		await this.insightsBufferService.shutdown();
